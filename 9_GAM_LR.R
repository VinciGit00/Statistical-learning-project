...
# Smoothing splines
b <-   paste0("Sleep.Duration ~ ", paste0("lo(",use,")", collapse= "+"),"+", paste0(dontuse,collapse="+"),collapse="")
...
ks.test(model_gam$residuals, 'pnorm') # test normalità kolgomorov-smirnov (se pvalue > 0.05 allora dati sono normali)
